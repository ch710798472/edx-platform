...
"""
from ..helpers import UniqueCourseTest, EventsTestMixin, load_data_str
...
@attr('shard_5')
class CertificateProgressPageTest(EventsTestMixin, UniqueCourseTest):
    """
    ...
    def setUp(self):
        ...
        self.course_fixture.add_handout('demoPDF.pdf')
    ...
    def test_progress_page_has_view_certificate_button(self):
        ...
        actual_padding = self.progress_page.get_element_padding('.wrapper-msg.wrapper-auto-cert')
        actual_padding = [int(padding) for padding in actual_padding.itervalues()]
        expected_padding = [0, 0, 0, 0]

        # See issue SOL-1196 for details of this check
